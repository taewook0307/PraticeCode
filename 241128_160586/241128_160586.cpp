// 241128_160586.cpp : 이 파일에는 'main' 함수가 포함됩니다. 거기서 프로그램 실행이 시작되고 종료됩니다.
//
...
int main()
{
    std::vector<int> Result = solution({ "ABACD", "BCEFD" }, { "ABCD","AABB" });
    std::vector<int> Result1 = solution({ "AA"}, {"B"});
    std::vector<int> Result2 = solution({ "AGZ", "BSSS" }, { "ASA", "BGZ" });
