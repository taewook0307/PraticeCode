// 241016_12985.cpp : 이 파일에는 'main' 함수가 포함됩니다. 거기서 프로그램 실행이 시작되고 종료됩니다.
//
...
int solution(int n, int a, int b)
{
    ...
    while (1)
    {
        ...
        a = std::ceil(static_cast<double>(a) / 2);
        b = std::ceil(static_cast<double>(b) / 2);
        ++answer;
    }
...
int main()
{
    std::cout << solution(8, 4, 7) << std::endl;
}
