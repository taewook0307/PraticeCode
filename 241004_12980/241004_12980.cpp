// 241004_12980.cpp : 이 파일에는 'main' 함수가 포함됩니다. 거기서 프로그램 실행이 시작되고 종료됩니다.
//
...
{
    solution(5);
    // Jump(1), Teleport(2), Teleport(4), Jump(1) : 2
    solution(6);
    // Jump(1), Teleport(2), Jump(3), Teleport(6) : 2
    solution(10);
    // Jump(1), Teleport(2), Teleport(4), Jump(5), Teleport(10) : 2
    solution(20);
