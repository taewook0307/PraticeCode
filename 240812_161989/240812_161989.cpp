// 240812_161989.cpp : 이 파일에는 'main' 함수가 포함됩니다. 거기서 프로그램 실행이 시작되고 종료됩니다.
//
...
int main()
{
    std::vector<int> section0 = { 2, 3, 6 };
    PrintResult(8, 4, section0);

    std::vector<int> section1 = { 1, 3 };
    PrintResult(5, 4, section1);

    std::vector<int> section2 = { 1, 2, 3, 4 };
    PrintResult(4, 1, section2);
}
