// 241112_17686.cpp : 이 파일에는 'main' 함수가 포함됩니다. 거기서 프로그램 실행이 시작되고 종료됩니다.
//
...
// stable_sort 이용 시 index 필요 없음

int main()
{
    std::vector<std::string> Result = solution({ "img12.png", "img10.png", "img02.png", "img1.png", "IMG01.GIF", "img2.JPG" });
    std::vector<std::string> Result0 = solution({ "F13.png", "F14", "f013", "F014", "F013.TXT" });
                                                // "F13.png", "f013", "F013.TXT", "F14", "F014"
    std::vector<std::string> Result1 = solution({ "a000011", "a00001" });
                                                // "a000011", "a00001"
    std::vector<std::string> Result2 = solution({ "a0001", "a001", "a000001" });
                                                // "a000001", "a0001", "a001"
    std::vector<std::string> Result3 = solution({ "F-15", "f15", "F15.png" });
                                                // "f15", "F15.png", "F-15"
